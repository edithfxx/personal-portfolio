...
作品內容從 `Vue` 資料管理、`JavaScript` 互動遊戲，到靜態切版與 `CSS Animation` 練習都有涵蓋，目的是呈現我面對不同題型時的前端實作能力與思考方式。

README 主要整理各作品的定位、亮點與可延伸到職場實務的能力，方便面試官或用人主管快速理解我的技術基礎、作品方向，以及我在畫面、互動與資料處理上的累積。

如果你正在尋找願意持續學習、能穩定完成前端實作，並重視使用者體驗與程式可維護性的前端夥伴，歡迎進一步交流。
